 ...
 */
package www.wanlinruo.com.basemvpprobject.lifecycle;
...
public class ActivityLifecycleForRxLifecycle implements Application.ActivityLifecycleCallbacks {
    ...
    private static final ActivityLifecycleForRxLifecycle instance = new ActivityLifecycleForRxLifecycle();

    private ActivityLifecycleForRxLifecycle() {
    }

    public static ActivityLifecycleForRxLifecycle getInstance() {
        return instance;
    }
