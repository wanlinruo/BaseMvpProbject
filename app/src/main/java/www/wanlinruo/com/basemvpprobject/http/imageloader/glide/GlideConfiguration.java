...
import www.wanlinruo.com.basemvpprobject.http.OkHttpUrlLoader;
...
import www.wanlinruo.com.basemvpprobject.utils.FileUtil;
...
//                return DiskLruCacheWrapper.get(DataHelper.makeDirs(new File(appComponent.cacheFile(), "Glide")), IMAGE_DISK_CACHE_MAX_SIZE);
                return DiskLruCacheWrapper.get(FileUtil.makeDirs(new File(FileUtil.getCacheFile(context), "Glide")), IMAGE_DISK_CACHE_MAX_SIZE);
            }
        });
